...
function update(){
	...
	if(nextseconds != curseconds){
		...
		if(parseInt(curseconds/10)!=parseInt(nextseconds/10)){
			addBalls(MARGIN_LEFT+40*(RADIUS+1),MARGIN_TOP,parseInt(curseconds/10));
		}
		if(parseInt(curseconds%10)!=parseInt(nextseconds%10)){
			addBalls(MARGIN_LEFT+60*(RADIUS+1),MARGIN_TOP,parseInt(nextseconds/10));
		}
...
function render(cxt){
	...
	renderDigit(MARGIN_LEFT+40*(RADIUS+1),MARGIN_TOP,parseInt(seconds/10),cxt);
	renderDigit(MARGIN_LEFT+60*(RADIUS+1),MARGIN_TOP,parseInt(seconds%10),cxt);
